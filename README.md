...
_Na implementação do GET o usuário solicita o processamento através de uma URL e envia o parâmetro ´nome´ para o servlet e ele retorna a imagem gerada na resposta.
